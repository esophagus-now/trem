...
void Block_proc::thread_ap_return() {
    ap_return = in_V_0_data_out.read();
}

void Block_proc::thread_in_V_0_ack_in() {
    in_V_0_ack_in = in_V_0_state.read()[1];
}

void Block_proc::thread_in_V_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(in_V_0_vld_out.read(), ap_const_logic_1))) {
...
void Block_proc::thread_in_V_0_data_out() {
...
void Block_proc::thread_in_V_0_load_A() {
    in_V_0_load_A = (in_V_0_state_cmp_full.read() & ~in_V_0_sel_wr.read());
}

void Block_proc::thread_in_V_0_load_B() {
    in_V_0_load_B = (in_V_0_sel_wr.read() & in_V_0_state_cmp_full.read());
}

void Block_proc::thread_in_V_0_sel() {
    in_V_0_sel = in_V_0_sel_rd.read();
}

void Block_proc::thread_in_V_0_state_cmp_full() {
...
void Block_proc::thread_in_V_0_vld_in() {
    in_V_0_vld_in = in_V_TVALID.read();
}

void Block_proc::thread_in_V_0_vld_out() {
