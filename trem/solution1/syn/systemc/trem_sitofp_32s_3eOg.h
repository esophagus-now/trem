...
#ifndef __trem_sitofp_32s_3eOg__HH__
#define __trem_sitofp_32s_3eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(trem_sitofp_32s_3eOg) {
    ...
    SC_CTOR(trem_sitofp_32s_3eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
