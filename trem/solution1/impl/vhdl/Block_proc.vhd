...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (in_V_0_vld_out = ap_const_logic_1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, in_V_0_vld_out, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_done_reg, in_V_0_vld_out, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (in_V_0_vld_out = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(in_V_0_vld_out, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (in_V_0_vld_out = ap_const_logic_1))) then 
